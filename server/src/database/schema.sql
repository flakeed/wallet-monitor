-- Add stablecoin columns to transactions table
ALTER TABLE transactions
ADD COLUMN IF NOT EXISTS stablecoin_spent DECIMAL(20,9) DEFAULT 0,
ADD COLUMN IF NOT EXISTS stablecoin_received DECIMAL(20,9) DEFAULT 0,
...
-- Optimize PostgreSQL settings for bulk operations (apply in postgresql.conf or session)
SET work_mem = '256MB';
...
-- Create function for bulk wallet insertion
...
-- Create function for bulk import stats
...
-- Monitoring view for bulk imports
